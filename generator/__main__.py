...
class ImageMachine:
    ...
    products_basedir = os.path.join(PROJECT_DIR, "output_data")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--mode", help=f"mode, one of {IMAGE_GENERATOR_REGISTRY.keys()}"
    )
    ...
    parser.add_argument("--clear_output", help="清空mode类输出文件夹下所有内容",
                        action="store_true")
