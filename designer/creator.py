...
class VistaDesigner:
    ...
    def get_template_from_url(self, url):
        ...
        if next_page:
            templates.extend(
                self.get_template_from_url(self.url + next_page[1]))
        return templates
    ...
    def load(self, template="62f15b94ca4d77aa72947d26", save_dir='.'):
        ...
        project_post = {
            ...
            "originalDimensions": {"width"       : str(template_json['width']),
                                   "height"      : str(template_json['height']),
                                   "measureUnits": template_json[
                                       'measureUnits']},
    ...
    def _get_pdf_url(self, download_id):
        ...
        while cnt < self.max_retry_times:
            check_url = f"https://create.vista.com/api/downloads/{download_id}?pagesRange=1"
...
if __name__ == '__main__':
    d = VistaDesigner()
    d.load_all('https://create.vista.com/templates/all-formats/coupons/',r'E:\00IT\P\uniform\multilang\templates\coupons\en')