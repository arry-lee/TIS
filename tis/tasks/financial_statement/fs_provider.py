...
class Provider(BaseProvider):
    ...
    def columns(self, n=None, multiline=True):
        if not n:
            if multiline:
                return "\n".join(self.random_element(self._columns_list).split())
            else:
    ...
    def words(self, nb):
        ...
        return self.random_elements(self._word_list, nb)
...
if __name__ == "__main__":
    ...
    t = table2image(x, font_size=40, line_pad=-2, vrules=None, hrules=None)["image"]
    cv2.imwrite("t.jpg", t)
